...
| <p>Add <br>Cancelled Executed Modified</p>                | marketModel           | <p>A - (Auction) when order was placed during auction</p><p>T - (Trading) when order was placed on continues trading mode<br><code>NEW</code> RA- (Resume Auction) when order was placed during auction after halt or autoHalt</p>                                                                               |
...
| <p>Executed<br>TradeReport<br>TradeCancel</p>             | tradingMode           | <p>IA - (Scheduled Intraday Auction) -When execution was as part of auction<br>CT -  (Continuous Trading) - When execution was done on a regular trading<br>ON -  Trade Reporting (On Exchange)<br><code>NEW</code> UA- (Unscheduled Auction) - When execution was as part of auction after halt or autoHalt</p> |
