...
| <p>Add <br>Cancelled Executed Modified<br>TradeCancel</p> | <p><mark style="color:red;">To be deprecated</mark></p><p>userId</p>    | Same as in `placeOrder` request                                                                                                                                                                                                                                                                 |
| <p>Add <br>Cancelled Executed Modified<br>TradeCancel</p> | <p><mark style="color:red;">To be deprecated</mark></p><p>accountId</p> | Same as in `placeOrder` request                                                                                                                                                                                                                                                                 |
