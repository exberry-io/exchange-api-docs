...
| <p><mark style="color:red;">To be deprecated</mark></p><p>userId</p><p><code>optional</code></p> | String     | Reference data only which is not being used in the exchange. 20 characters length, \[a-z,A-Z,0-9]                                                                                                                                       |
| <p><mark style="color:red;">To be deprecated</mark></p><p>accountId <code>optional</code></p>    | Integer    | Account ID of the order                                                                                                                                                                                                                 |
...
| 1001                                      | <p><code>Order must contain a positive quantity</code> or<br><code>Market order must not specify price</code> or<br><mark style="color:red;">Removed</mark> <del><code>Limit order must contain a positive price</code> or</del><br><code>Wrong orderType</code> or<br><code>Wrong side</code> or<br><code>Wrong mpOrderId</code> or<br><code>Wrong userId</code> or<br><code>Wrong timeInForce</code> or<br><code>Wrong expiryDate</code>or<br><code>Latests expiryDate is one year</code>or</p><p><code>Wrong [FieldName]</code> or</p><p><code>[FieldName] must be ≤ [maxLong/10^ fieldPrecision]</code> or<br><code>[FieldName] must ≥ [minLong/10^ fieldPrecision]</code></p> |
...
| 1013 <mark style="color:blue;">NEW</mark> | `Maximum order value is [maxOrderValue]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| 1014 <mark style="color:blue;">NEW</mark> | `Price tick size is [tickSize]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| ----------------------------------------- | ----------------------------------------------- |
| 1                                         | `Exchange is unavailable`                       |
| 1001 <mark style="color:blue;">NEW</mark> | `Wrong [FieldName]`                             |
| 1003                                      | `Market is closed`                              |
| 1004                                      | `Instrument trading is not allowed`             |
| 1007                                      | `Invalid session`                               |
| 1008                                      | `This apiKey doesn’t have the right permission` |
| 1009                                      | `Instrument trading is halt`                    |
| 1011                                      | `Permission denied for this instrument`         |
| 1018 <mark style="color:blue;">NEW</mark> | `Trading is not allowed`                        |
...
| 1006                                      | <p><code>Quantity increment is [quantityIncrement]</code> or<br><code>Minimum order quantity is [MinOrderQuantity]</code></p> |
| 1007                                      | `Invalid session`                                                                                                             |
| 1008                                      | `This apiKey doesn’t have the right permission`                                                                               |
| 1009                                      | `Instrument trading is halt`                                                                                                  |
| 1011                                      | `Permission denied for this instrument`                                                                                       |
...
| 1                                         | `Exchange is unavailable`                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 1000                                      | `Missing fields: [Fieldname]`                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 1001                                      | <p><code>Wrong [FieldName]</code> or</p><p><code>Order must contain a positive quantity</code> or<br><code>Limit order must contain a positive price</code>or<br><code>Latest expiryDate is one year</code> or<br><code>Wrong timeInForce</code> or <br><code>Wrong expiryDate</code> or<br><code>Order [FieldName] must be less than [maxLong/10^ fieldPrecision]</code> or<br><code>Order [FieldName] must be above than [minLong/10^ fieldPrecision]</code></p> |
| 1003                                      | `Market is closed`                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 1004                                      | `Instrument trading is not allowed`                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 1005                                      | <p><code>Quantity precision is[QuantityPrecision]</code> or<br><code>Price precision is[PricePrecision]</code></p>                                                                                                                                                                                                                                                                                                                                                 |
| 1006                                      | <p><code>Minimum order quantity is [MinOrderQuantity]</code> or<br><code>Maximum order quantity is [MaxOrderQuantity]</code> or<br><code>Quantity increment is [quantityIncrement]</code></p>                                                                                                                                                                                                                                                                      |
| 1007                                      | `Invalid session`                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 1008                                      | `This apiKey doesn’t have the right permission`                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 1009                                      | `Instrument trading is halt`                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 1010 <mark style="color:blue;">NEW</mark> | `Instrument [Instrument] not found`                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 1011                                      | `Permission denied for this instrument`                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 1012                                      | `Price breaches [FieldName] of [FieldValue]`                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| 1018 <mark style="color:blue;">NEW</mark> | `Trading is not allowed`                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| 1030                                      | <p><code>Trading is not allowed during crossing</code> or<br><code>Only [Allowed TIF] limit orders are allowed</code></p>                                                                                                                                                                                                                                                                                                                                          |
| 1031 <mark style="color:blue;">NEW</mark> | `GAA is allowed only during auction`                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 1100                                      | `Order not found for that instrument`                                                                                                                                                                                                                                                                                                                                                                                                                              |
