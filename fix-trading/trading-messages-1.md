...
| <mark style="color:blue;">NEW</mark> 11                         | ClOrdID                   | Y        | <p>ClOrdID of the order<br>Only when TrdType = 0 (Regular trade)<br>For both TradeReportTransType 0 (New) and 1(Cancel) </p>                                                                                                                                                                                             |
| <p><mark style="color:red;">will be removed</mark></p><p>41</p> | OrigClOrdID               | N        | Ignore                                                                                                                                                                                                                                                                                                                   |
