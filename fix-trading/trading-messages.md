...
{% tabs %}
{% tab title="Request" %}
<pre data-overflow="wrap"><code><strong>8=FIXT.1.1|9=162|35=D|49=yael|56=EXBERRY|34=456|52=20221123-14:57:43.764000|11=1669215463763|38=1|40=2|44=1|54=2|55=yael1|59=1|453=2|448=123456|447=D|452=38|448=ABCD|447=D|452=12|10=010|8=FIXT.1.1|9=258|35=8|49=EXBERRY|56=yael|34=100918|52=20221123-14:57:45.524312|
</strong></code></pre>
{% endtab %}
...
{% code overflow="wrap" %}
```
8=FIXT.1.1|9=108|35=3|49=EXBERRY|56=yael|34=41|52=20221127-11:58:09.732658|45=40|371=59|372=D|373=6|58=Wrong TimeInForce(59)|10=075|
```
{% endcode %}
{% endtab %}
{% endtabs %}
...
{% code overflow="wrap" %}
```
8=FIXT.1.1|9=89|35=F|49=yael|56=EXBERRY|34=85|52=20221124-08:56:48.583000|11=1669280208583|37=4|55=yael1|10=144|
```
{% endcode %}
{% endtab %}
...
{% code overflow="wrap" %}
```
 8=FIXT.1.1|9=129|35=9|49=EXBERRY|56=yael|34=100924|52=20221123-15:00:34.041028|37=NONE|434=1|102=1100|39=8|58=Order not found for that instrument|10=015|
```
{% endcode %}
{% endtab %}
{% endtabs %}
...
{% code overflow="wrap" %}
```
 8=FIXT.1.1|9=97|35=G|49=yael|56=EXBERRY|34=62|52=20221127-12:06:35.980000|11=1669550795980|37=8|38=0.12|55=yael1|10=251|
```
{% endcode %}
...
{% code overflow="wrap" %}
```
8=FIXT.1.1|9=90|35=q|49=yael|56=EXBERRY|34=12|52=20221124-09:32:09.451000|11=1669282329451|55=yael1|530=1|10=198|
```
{% endcode %}
...
{% code overflow="wrap" %}
```
8=FIXT.1.1|9=255|35=8|49=EXBERRY|56=yael|34=5|52=20221127-11:42:36.138119|17=37259|55=yael1|37=5|41=1669549352750|150=0|40=2|39=0|54=2|59=1|44=100.0|38=1.0|14=0.0|151=1.0|60=20221127-11:42:36.130166|453=3|448=123456|447=D|452=38|448=ABCD|447=D|452=12|448=yael|447=D|452=7|10=221|
```
{% endcode %}
{% endtab %}
...
{% code overflow="wrap" %}
```
8=FIXT.1.1|9=121|35=8|49=EXBERRY|56=yael|34=10|52=20221127-11:45:00.373231|17=37260|150=8|37=-1|39=8|103=1010|58=Instrument FIX not found|10=169|
```
{% endcode %}
{% endtab %}
...
{% code overflow="wrap" %}
```
 8=FIXT.1.1|9=290|35=8|49=EXBERRY|56=yael|34=47|52=20221127-12:00:27.256013|17=37266|55=yael1|37=7|41=1669550423866|150=F|40=2|39=2|54=1|59=1|44=100.0|38=1.0|14=1.0|151=0.0|31=100.0|32=1.0|880=4|60=20221127-12:00:27.243980|75=20221127|453=3|448=123456|447=D|452=38|448=ABCD|447=D|452=12|448=yael|447=D|452=7|10=049|
```
{% endcode %}
{% endtab %}
...
{% code overflow="wrap" %}
```
 8=FIXT.1.1|9=254|35=8|49=EXBERRY|56=yael|34=14|52=20221127-11:46:41.698965|17=37261|55=yael1|37=5|41=1669549352750|150=4|40=2|39=4|54=2|59=1|44=100.0|38=1.0|14=0.0|151=0|60=20221127-11:46:41.692550|453=3|448=123456|447=D|452=38|448=ABCD|447=D|452=12|448=yael|447=D|452=7|10=204|
```
{% endcode %}
{% endtab %}
...
{% code overflow="wrap" %}
```
8=FIXT.1.1|9=258|35=8|49=EXBERRY|56=yael|34=64|52=20221127-12:06:39.375990|17=37269|55=yael1|37=8|41=1669550567403|150=5|40=2|39=0|54=2|59=1|44=10.0|38=1.00|14=0.00|151=0.12|60=20221127-12:06:39.364379|453=3|448=123456|447=D|452=38|448=ABCD|447=D|452=12|448=yael|447=D|452=7|10=156|
```
{% endcode %}
{% endtab %}
{% endtabs %}
...
| 17                                                      | ExecID           | Y        | <p>Unique identifier of execution report<br>0 = Case of Order Mass Status Request (AF) response</p>                                                                                                                                                                                                                                                                                                                                          |
...
| <mark style="color:blue;">NEW</mark> 581                | AccountType      | N        | <p>Account type </p><p>1 = Client </p><p>3 = House</p>                                                                                                                                                                                                                                                                                                                                                                                       |
| <mark style="color:blue;">NEW</mark>  912               | LastRptRequested | N        | <p>Will be included only in case I = Order Status Identify if this is the last record<br>N = for all records</p><p>Y =  for the last record</p>                                                                                                                                                                                                                                                                                              |
| <p><mark style="color:blue;">NEW</mark>  </p><p>584</p> | MassStatusReqID  | N        | Will be included only in case ExecType (150) = I (Order Status)                                                                                                                                                                                                                                                                                                                                                                              |
| <p><mark style="color:blue;">NEW</mark> <br>+</p>       | Parties          | N        | <p>This is party information related to the submitter of the request.<br>See <a href="trading-messages.md#parties-component">here </a>for more details </p>                                                                                                                                                                                                                                                                                  |
...
{% code overflow="wrap" %}
```
8=FIXT.1.1|9=87|35=r|49=EXBERRY|56=yael|34=20|52=20221127-11:48:39.808764|530=1|531=1|533=0|1369=37263|10=066|
```
{% endcode %}
{% endtab %}
...
{% code overflow="wrap" %}
```
8=FIXT.1.1|9=118|35=r|49=EXBERRY|56=yael|34=24|52=20221124-09:37:01.311422|530=1|531=0|532=1010|58=Instrument FIX not found|1369=37256|10=126|
```
{% endcode %}
{% endtab %}
{% endtabs %}
...
{% code overflow="wrap" %}
```
8=FIXT.1.1|9=125|35=9|49=EXBERRY|56=yael|34=27|52=20221127-11:52:00.728920|37=NONE|434=1|102=1100|39=8|58=Order not found for that instrument|10=081
```
{% endcode %}
