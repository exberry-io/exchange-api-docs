...
<table><thead><tr><th width="349.3333333333333">Scenario</th><th width="195">ExecType(150)</th><th>OrdStatus(39)</th></tr></thead><tbody><tr><td>Order Rejected</td><td>8 (Rejected)</td><td>8 (Rejected)</td></tr><tr><td>Order accepted (or triggered) and order is fully resting on the book</td><td>0 (New)</td><td>0 (New)</td></tr><tr><td>Order accepted (or triggered) and order is fully executed immediately</td><td>F (Trade)</td><td>2 (Filled)</td></tr><tr><td>Order accepted (or triggered) and order is partially executed immediately and the residual is resting on the book</td><td><p>F (Trade) &#x26;</p><p>0 (New)</p></td><td><p>1 (Partially filled) &#x26;</p><p>1 (Partially filled)</p></td></tr><tr><td>Order accepted (or triggered) and order is partially executed immediately and the residual is cancelled (IOC)</td><td><p>F (Trade) &#x26;</p><p>4 (Canceled)</p></td><td><p>1 (Partially filled) &#x26;</p><p>4 (Canceled)</p></td></tr><tr><td>Order with immediate TIF (IOC, FOK) that failed to be executed</td><td>4 (Canceled)</td><td>4 (Canceled)</td></tr><tr><td>GTD order that has expired</td><td>4 (Canceled)</td><td>4 (Canceled)</td></tr><tr><td>Order cancelled</td><td>4 (Canceled)</td><td>4 (Canceled)</td></tr><tr><td>Order modified</td><td>5 (Replaced)</td><td><p>0 (New) OR</p><p>1 (Partially filled)</p></td></tr><tr><td>Order replaced</td><td>4 (Canceled) &#x26;<br>0 (New)</td><td>4 (Canceled) &#x26;<br>0 (New)</td></tr><tr><td><mark style="color:blue;">(CHANGED v1.21.0)</mark><br>Order suspended </td><td><del>9 (Suspended)</del><br>0 (New)</td><td><del>9 (Suspended)</del><br>0 (New)</td></tr><tr><td><mark style="color:blue;">(NEW v1.21.0)</mark><br>Order injected </td><td>L (Triggered or Activated by System)</td><td>0 (New)</td></tr></tbody></table>
...
If the request is only to reduce the LeavesQty of an order(OrderQty of the request < LeavesQty of the order); other fields may present with the same values as the original order or be omitted from request, the system modifies the existing order, the behavior is similar to [modifyOrder](../trading-api.md#modifyorder) of the WS.

Any other request would result in the system canceling the existing order and creating a new one, the behavior is similar to [replaceOrder](../trading-api.md#replaceorder) of the WS.
...
fixin 8=FIXT.1.1|9=296|35=8|49=EXBERRY|56=JPMA|34=15|52=20231026-13:39:21.992076|17=3290|55=AAPL|37=37|11=1698327561897|41=1698327435682|150=5|40=4|39=0|636=N|54=1|59=1|44=150.3333|99=180.0000|38=1|14=0.000000|151=1.000000|60=20231026-13:39:21.983037|453=3|448=123456|447=D|452=38|448=ABCD|447=D|452=12|448=JPM-1|447=D|452=7|10=056|
```
{% endcode %}
{% endtab %}
